...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if response.status_code == 200:
            ...
            speak_output = text + " Como posso te ajudar seu lindo?"
            response_text = {
                "role": "model",
                "parts": [{
                    "text": text
...
class CatchAllExceptionHandler(AbstractExceptionHandler):
    ...
    def handle(self, handler_input, exception):
        ...
        speak_output = "Desculpe, houve um problema na solicitação. Por favor, tente novamente mais tarde. só pra constar deu erro mano"
